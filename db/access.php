...
$capabilities = [
    ...
    'block/superframe:myaddinstance' => [
        'captype' => 'write',
    ...
    'block/superframe:seeviewpagelink' => [
        'captype' => 'read',
        'contextlevel' => CONTEXT_BLOCK,
        'archetypes' => [
            'editingteacher' => CAP_ALLOW,
    ...
    'block/superframe:viewenrolledstudents' => [
        'captype' => 'read',
        'contextlevel' => CONTEXT_BLOCK,
        'archetypes' => [
            'manager' => CAP_ALLOW,
